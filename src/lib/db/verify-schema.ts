...
export const EXPECTED_SCHEMA_MATRIX: Record<string, ExpectedTable> = {
  ...
  cvm_fii_registry: {
    name: 'cvm_fii_registry',
    primaryKey: 'id',
    uniqueConstraints: ['uq_cvm_fii_registry_cnpj'],
    columns: [
      { name: 'id', type: 'uuid', isNullable: false },
      { name: 'cnpj', type: 'text', isNullable: false },
      { name: 'legal_name', type: 'text', isNullable: false },
      { name: 'trade_name', type: 'text', isNullable: true },
      { name: 'ticker', type: 'text', isNullable: true },
      { name: 'isin', type: 'text', isNullable: true },
      { name: 'source', type: 'text', isNullable: false, hasDefault: true },
      { name: 'source_updated_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: true },
      { name: 'created_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: false, hasDefault: true },
      { name: 'updated_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: false, hasDefault: true },
    ],
  },
  cvm_fii_bindings: {
    name: 'cvm_fii_bindings',
    primaryKey: 'id',
    uniqueConstraints: ['uq_cvm_fii_bindings_pair'],
    foreignKeys: [
      {
        column: 'fii_registry_id',
        foreignTable: 'cvm_fii_registry',
        foreignColumn: 'id',
        deleteRule: 'RESTRICT',
      },
      {
    ...
    columns: [
      { name: 'id', type: 'uuid', isNullable: false },
      { name: 'fii_registry_id', type: 'uuid', isNullable: false },
      { name: 'asset_id', type: 'uuid', isNullable: false },
      { name: 'binding_status', type: 'text', isNullable: false, hasDefault: true },
      { name: 'binding_method', type: 'text', isNullable: false, hasDefault: true },
      { name: 'confidence_level', type: 'text', isNullable: false, hasDefault: true },
      { name: 'justification', type: 'text', isNullable: true },
      { name: 'source', type: 'text', isNullable: false, hasDefault: true },
      { name: 'source_updated_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: true },
      { name: 'reviewed_by', type: 'uuid', isNullable: true },
      { name: 'reviewed_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: true },
      { name: 'created_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: false, hasDefault: true },
      { name: 'updated_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: false, hasDefault: true },
    ],
  },
  fii_monthly_fundamentals: {
    name: 'fii_monthly_fundamentals',
    primaryKey: 'id',
    uniqueConstraints: ['uq_fii_monthly_fundamentals_versioning'],
    foreignKeys: [
      {
        column: 'fii_registry_id',
        foreignTable: 'cvm_fii_registry',
    ...
    columns: [
      { name: 'id', type: 'uuid', isNullable: false },
      { name: 'fii_registry_id', type: 'uuid', isNullable: false },
      { name: 'reference_date', type: 'date', isNullable: false },
      { name: 'filing_date', type: ['timestamp with time zone', 'timestamptz'], isNullable: true },
      { name: 'version', type: ['integer', 'int4'], isNullable: false, hasDefault: true },
      { name: 'source', type: 'text', isNullable: false, hasDefault: true },
      { name: 'source_reference', type: 'text', isNullable: true },
      { name: 'net_asset_value', type: 'numeric', isNullable: true },
      { name: 'quota_equity_value', type: 'numeric', isNullable: true },
      { name: 'issued_quotas', type: 'numeric', isNullable: true },
      { name: 'total_assets', type: 'numeric', isNullable: true },
      { name: 'total_liabilities', type: 'numeric', isNullable: true },
      { name: 'cash_equivalents', type: 'numeric', isNullable: true },
      { name: 'dividend_declared_per_quota', type: 'numeric', isNullable: true },
      { name: 'investors_count', type: ['integer', 'int4'], isNullable: true },
      { name: 'individual_investors_count', type: ['integer', 'int4'], isNullable: true },
      { name: 'created_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: false, hasDefault: true },
      { name: 'updated_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: false, hasDefault: true },
    ],
  },
  ...
  editorial_documents: {
    ...
    columns: [
      ...
      { name: 'content_format', type: 'text', isNullable: false, hasDefault: true },
      { name: 'document_type', type: 'text', isNullable: false },
      { name: 'status', type: 'text', isNullable: false, hasDefault: true },
      { name: 'visibility', type: 'text', isNullable: false, hasDefault: true },
      { name: 'current_version', type: ['integer', 'int4'], isNullable: false, hasDefault: true },
      { name: 'created_by', type: 'text', isNullable: false },
      { name: 'updated_by', type: 'text', isNullable: false },
      { name: 'approved_by', type: 'text', isNullable: true },
      { name: 'approved_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: true },
      { name: 'published_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: true },
      { name: 'archived_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: true },
      { name: 'rejection_reason', type: 'text', isNullable: true },
      { name: 'regulatory_flags', type: 'jsonb', isNullable: false, hasDefault: true },
      { name: 'metadata', type: 'jsonb', isNullable: false, hasDefault: true },
      { name: 'deleted_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: true },
      { name: 'created_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: false, hasDefault: true },
      { name: 'updated_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: false, hasDefault: true },
    ],
  ...
  editorial_versions: {
    name: 'editorial_versions',
    primaryKey: 'id',
    uniqueConstraints: ['uq_editorial_versions_doc_ver'],
    foreignKeys: [
      {
        column: 'document_id',
        foreignTable: 'editorial_documents',
        foreignColumn: 'id',
        deleteRule: 'CASCADE',
      },
    ],
    columns: [
      ...
      { name: 'version_number', type: ['integer', 'int4'], isNullable: false },
      { name: 'title', type: 'text', isNullable: false },
      { name: 'content', type: 'text', isNullable: false },
      { name: 'author_id', type: 'text', isNullable: false },
      { name: 'origin', type: 'text', isNullable: false },
      { name: 'content_hash', type: 'text', isNullable: false },
      { name: 'notes', type: 'text', isNullable: true },
      { name: 'created_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: false, hasDefault: true },
    ],
  },
  editorial_reviews: {
    ...
    columns: [
      ...
      { name: 'decision', type: 'text', isNullable: false },
      { name: 'comments', type: 'text', isNullable: false },
      { name: 'regulatory_flags', type: 'jsonb', isNullable: false, hasDefault: true },
      { name: 'created_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: false, hasDefault: true },
    ],
  },
  editorial_ai_executions: {
    name: 'editorial_ai_executions',
    primaryKey: 'id',
    foreignKeys: [
      {
        column: 'document_id',
    ...
    columns: [
      { name: 'id', type: 'uuid', isNullable: false },
      { name: 'document_id', type: 'uuid', isNullable: true },
      { name: 'user_id', type: 'uuid', isNullable: false },
      { name: 'action_type', type: 'text', isNullable: false },
      { name: 'model', type: 'text', isNullable: false },
      { name: 'prompt_sanitized', type: 'text', isNullable: false },
      { name: 'response_sanitized', type: 'text', isNullable: false },
      { name: 'status', type: 'text', isNullable: false },
      { name: 'error_message', type: 'text', isNullable: true },
      { name: 'created_at', type: ['timestamp with time zone', 'timestamptz'], isNullable: false, hasDefault: true },
    ],
