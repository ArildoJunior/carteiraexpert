...
export const metadata: Metadata = {
  title: 'BDRs (Brazilian Depositary Receipts) — Cotações e Histórico | CarteiraExpert',
  description:
    'Consulte cotações, variações e histórico de BDRs de empresas internacionais negociados na bolsa brasileira (B3).',
  openGraph: {
    title: 'BDRs — Cotações e Histórico | CarteiraExpert',
    description:
      'Consulte cotações, variações e histórico de BDRs negociados na B3.',
  },
};

interface BdrsPageProps {
...
export default async function BdrsListingPage({ searchParams }: BdrsPageProps) {
    ...
    <div className="min-h-screen flex flex-col bg-background text-text-primary">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 w-full">
        <AssetListingView
          ...
          pageTitle="BDRs (Certificados de Depósito)"
          pageDescription="Acompanhe cotações em reais e dados de certificados de empresas globais negociados na B3."
        />
      </main>
      <PublicFooter />
    </div>
