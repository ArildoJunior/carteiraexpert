...
export const metadata: Metadata = {
  title: 'Fundos de Índice (ETFs) — Cotações e Histórico | CarteiraExpert',
  description:
    'Consulte cotações, variações e histórico de ETFs listados na bolsa brasileira (B3) e internacionais.',
  openGraph: {
    title: 'Fundos de Índice (ETFs) — Cotações e Histórico | CarteiraExpert',
    description:
      'Consulte cotações, variações e histórico de ETFs listados na B3.',
  },
};
...
export default async function EtfsListingPage({ searchParams }: EtfsPageProps) {
    ...
    <div className="min-h-screen flex flex-col bg-background text-text-primary">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 w-full">
        <AssetListingView
          ...
          pageTitle="Fundos de Índice (ETFs)"
          pageDescription="Acompanhe cotações, variações e histórico dos fundos de índice referenciados em índices nacionais e globais."
        />
      </main>
      <PublicFooter />
    </div>
