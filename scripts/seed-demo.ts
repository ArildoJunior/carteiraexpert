...
async function main() {
  ...
  const tickerList = [
    ...
    // Extras exigidos pelo seed.test.ts (sem transacoes/positions, apenas cadastrados)
    { ticker: "HGLG11", name: "CSHG Logistica FII", assetClass: "reit" as const },
    { ticker: "BOVA11", name: "iShares Bovespa Index ETF", assetClass: "etf" as const },
    { ticker: "BTC", name: "Bitcoin", assetClass: "crypto" as const },
    { ticker: "ETH", name: "Ethereum", assetClass: "crypto" as const },
  ];
